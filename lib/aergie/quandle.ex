defmodule Quandle do
  @moduledoc """
    not working anymore, since last updated data we receive is from june 2021.
    
    Probably need to call a newer version of this API
  """
  ...
  def getLastValue(mnemo \\ "GLE") do
    ...
    case :httpc.request(:get, {'#{url}',[]}, @timeout, []) do
      {:ok,{{_,200,_},_head,body}} -> res = Poison.decode!(body)["dataset"]["data"] |> hd
